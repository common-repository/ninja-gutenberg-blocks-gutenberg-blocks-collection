		...
		<InspectorControls key="inspector">
			...
			>
				...
				<RangeControl
					...
					max={50}
					step={1}
					value={NinjaDividerPaddingTop}
					onChange={NinjaDividerPaddingTop =>
						setAttributes({ NinjaDividerPaddingTop })
					}
					initialPosition={0.1}
				/>
				<RangeControl
					...
					max={50}
					step={1}
					value={NinjaDividerPaddingBottom}
					onChange={NinjaDividerPaddingBottom =>
						setAttributes({ NinjaDividerPaddingBottom })
					}
					initialPosition={0.1}
				/>
			</PanelColorSettings>
