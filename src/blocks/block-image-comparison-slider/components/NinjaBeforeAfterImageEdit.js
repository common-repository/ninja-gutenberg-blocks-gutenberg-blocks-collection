...
class NinjaBeforeAfterImageEdit extends Component {
	componentDidUpdate() {
	...
	checkSliderArrow = () => {
		if (
			...
			!document.getElementById("ninja_arrow_left_slider") &&
			!document.getElementById("ninja_arrow_right_slider")
		) {
			let arrowLeftDiv = document.createElement("div");
			arrowLeftDiv.id = "ninja_arrow_left_slider";
			arrowLeftDiv.className = "ninja-left-arrow-slider";
			document.getElementsByClassName("slider")[0].appendChild(arrowLeftDiv);

			let arrowRightDiv = document.createElement("div");
			arrowRightDiv.id = "ninja_arrow_right_slider";
			arrowRightDiv.className = "ninja-right-arrow-slider";
			...
			content = (
				<div>
					<img
						...
						id={BeforeImageUrl ? "ninjaBeforeImg" : "ninjaAfterImage"}
					/>
				</div>
			);
		}
...
export default NinjaBeforeAfterImageEdit;
