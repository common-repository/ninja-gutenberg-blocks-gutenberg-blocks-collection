...
class PostGridEdit extends Component{
    ...
    render(){
        ...
        const postImageDefaultSizes = [
            ...
            { value: 'ninja_gutenberg_blocks_landscape_large', label: __( 'Landscape Large' ) },
            { value: 'ninja_gutenberg_blocks_portrait_large', label: __( 'Portrait Large' ) },
            { value: 'ninja_gutenberg_blocks_square_large', label: __( 'Square Large' ) },
            { value: 'ninja_gutenberg_blocks_landscape', label: __( 'Landscape Small' ) },
            { value: 'ninja_gutenberg_blocks_portrait', label: __( 'Portrait Small' ) },
            { value: 'ninja_gutenberg_blocks_square', label: __( 'Square Small' ) },
        ...
        return (
            <Fragment>
                ...
                <div className={`${ className } post-grid-view nb-d-flex nb-row nb-flex-wrap`}>
                    {
                        displayPosts.map( ( post, i ) =>
                            
                            <article className={`post-item nb-mlr-15 nb-mb-40 ${gridView} ${align}`}>
                                
                                {
                                    post.ninja_gutenberg_blocks_featured_media_urls[postImageSizes][0] && displayPostImage ? (
                                        <div className="post-image">
                                            <a href={ post.link } target="_blank" rel="bookmark">
                                                <img src={ post.ninja_gutenberg_blocks_featured_media_urls[postImageSizes][0] }/>
                                            </a>
                                        </div>
                                    ) : ( null )
