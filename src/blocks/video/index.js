...
registerBlockType( 'ninja-blocks/video', {
    title : __('NB Video'),
    icon: 'video-alt2',
    ...
    save( props ){
        ...
        return(
            <a className={'wp-block-ninja-blocks-video venobox'}  href={ !!videoUrl ? videoUrl : '#' } data-autoplay="true" data-vbtype="video">
                
                <div className={'nb-video-btn-wrapper'} style={ btnWrapperStyle }>
                    <div className={ 'nb-video-preview-img' } style={ previewImageStyle } />
                    <div className={ 'nb-video-wrapper'}>
                        <div className={'nb-video-icon'} >
